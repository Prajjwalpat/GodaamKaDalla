...
def get_summary():
    try:
        ...
        logger.info(f"Calculated networth:{net_worth}, total quantity:{total_qty}")
        return jsonify({'networth of inventory':net_worth,'total stocks in inventory':total_qty}), 200
    except Exception as e:
        logger.exception("Error in getting summary")
